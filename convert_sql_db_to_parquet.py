...
cpts_and_scpt_dfs_with_valid_size = []
...
#         cpts_and_scpt_dfs_with_valid_size.append(cpt_loc.name)
#
#
# valid_cpts_df = pd.DataFrame(cpts_and_scpt_dfs_with_valid_size, columns=["cpt_name"])
# valid_cpts_df.to_csv(parquet_conversion_meta_output_dir / "valid_cpts.csv")

valid_cpts_and_scpts_df = pd.read_csv(parquet_conversion_meta_output_dir / "valid_cpts.csv")
valid_cpts = valid_cpts_and_scpts_df[~valid_cpts_and_scpts_df['cpt_name'].str.contains('SCPT')]
valid_scpts = valid_cpts_and_scpts_df[valid_cpts_and_scpts_df['cpt_name'].str.contains('SCPT')]
